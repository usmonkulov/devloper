...
use Yii;
use backend\models\PublicityImage;
use backend\models\search\PublicityImageSearch;
...
/**
 * PublicityImageController implements the CRUD actions for PublicityImage model.
 */
class PublicityImageController extends Controller
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        $searchModel = new PublicityImageSearch();
   ...
   public function actionDelete($id)
    ...
    {
        if (($model = PublicityImage::findOne($id)) !== null) {
            return $model;
        }
    ...
    public function actionActivate($id){
        $activ = PublicityImage::findOne($id);
