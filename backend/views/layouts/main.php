    ...
    <header class="header black-bg">
      ...
      <div class="top-menu">
       <!--  <ul class="nav pull-right top-menu">
            <li><a data-method="POST" class="logout" href="<?//= Url::to(['/site/logout'])?>"><i class="fa fa-power-off"></i></a></li>
        </ul> -->
          ...
          <ul class="nav pull-right top-menu navbar-right">
                ...
                <span class="fa fa-user"></span>
                    ...
                    <ul style="left: -103px;" class="dropdown-menu">
                        <li>
                          <a>
                              <?php if(Yii::$app->user->identity->image):?>
                                  <?= Html::img("@web/".Yii::$app->user->identity['image'],['class' => 'profile-image-logout','alt' => Yii::$app->user->identity['username']])?>
                              <?php else:?>
                                  <?= Html::img("@web/placeHolder/user.png", ['class' => 'profile-image-logout','alt' => Yii::$app->user->identity['username']])?>
                              <?php endif?>  
                        ...
                        <li><a data-method="POST" href="<?= \yii\helpers\Url::to(['user/view?id='.Yii::$app->user->identity->id])?>"><b> <?=Yii::t('yii','My profile')?></b></a></li>
      ...
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
           <li>
               <a href="#" data-toggle="dropdown" class="language dropdown-toggle"><?=\backend\components\LanguageDropdown::label(Yii::$app->language)?> <b class="caret"></b></a>
               <?php
                echo \backend\components\LanguageDropdown::widget();
               ?>  
           </li>
        </ul>
      </div>
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered">
            <a href="<?= \yii\helpers\Url::to(['user/view?id='.Yii::$app->user->identity->id])?>">
              <?php if(Yii::$app->user->identity->image):?>
                  <?= Html::img("@web/".Yii::$app->user->identity['image'],['class' => 'profile-image img-circle','alt' => Yii::$app->user->identity['username']])?>
              <?php else:?>
                  <?= Html::img("@web/placeHolder/user.png", ['class' => 'profile-image img-circle','alt' => Yii::$app->user->identity['username']])?>
              <?php endif?>  
              <!-- <img src="/admin/img/ui-sam.jpg" class="profile-image img-circle" width="80"> -->
            </a>
            <style>
              .profile-image {
                border-radius: 80px;
          ...
          <?php $controller = Yii::$app->controller->id; ?>
                <li class="mt">
                 ...
                 <li>
                    <a  class="<?= ($controller=='main-logo')?'active':''?>" href="<?= Url::to(['main-logo/'])?>">
                ...
                <li>
                 ...
                 <li>
                    <a  class="<?= ($controller=='publicity')?'active':''?>"  href="<?= Url::to(['publicity/'])?>">
                        ...
                        <span><?=Yii::t('yii', 'Advertisings')?> 300x250</span>
                    </a>
                </li>

                 <li>
                    <a  class="<?= ($controller=='publicity-image')?'active':''?>"  href="<?= Url::to(['publicity-image/'])?>">
                        <i class="fa fa-list-alt"></i>
                        <span><?=Yii::t('yii', 'Advertisings')?> 728x90</span>
                    </a>
                </li>
                ...
                <li>
                 ...
                 <li>
                    <a  class="<?= ($controller=='book-category')?'active':''?>"  href="<?= Url::to(['book-category/'])?>">
                        ...
                        <span><?=Yii::t('yii', 'Book Categories')?>
                    </a>
                </li>
                ...
                <li>
                    <a  class="<?= ($controller=='user')?'active':''?>"  href="<?= Url::to(['user/'])?>">
                        <i class="fa fa-list-alt"></i>
                        <span><?=Yii::t('yii', 'Users')?>
                    </a>
                </li>

                <li>
                    <a  class="<?= ($controller=='register')?'active':''?>"  href="<?= Url::to(['register/'])?>">
                        <i class="fa fa-list-alt"></i>
                        <span><?=Yii::t('yii', 'Registers')?>
                    </a>
                </li>

                 <li>
                    <a  class="<?= ($controller=='comment')?'active':''?>"  href="<?= Url::to(['comment/'])?>">
                        <i class="fa fa-list-alt"></i>
                        <span><?=Yii::t('yii', 'Comments')?>
                    </a>
                </li>

                <li>
                    <a  class="<?= ($controller=='profile')?'active':''?>"  href="<?= Url::to(['profile/'])?>">
                        <i class="fa fa-list-alt"></i>
                        <span><?=Yii::t('yii', 'Profile')?>
                    </a>
                </li>
