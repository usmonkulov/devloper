            ...
            <?= GridView::widget([
                ...
                'columns' => [
                    ...
                    [
                      ...
                      {
                        if($data->image):
                          return ($data->image != NULL && $data->image != '' && !empty($data->image)) ? Html::a(Html::img(\yii\helpers\Url::base().'/'.$data->image, ['class'=>'profil-index-image']),(\yii\helpers\Url::base().'/'.$data->image)) : '';
                        else:
