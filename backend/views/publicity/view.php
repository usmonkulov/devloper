            ...
            'model' => $model,
              'attributes' => [    
                ...
                [
                    ...
                    'value' => function($data){
                      if($data->image):
                        return ($data->image != NULL && $data->image != '' && !empty($data->image)) ? Html::a(Html::img(Yii::$app->urlManager->createUrl('../../frontend/web/'.$data->image),['style'=>'width:300px'], ['alt'=>$data->image]),['../../frontend/web/'.$data->image]) : '';
                      else:
                        return (Html::img('@web/placeHolder/ad-1.jpg',['style'=>'width:300px']));
                      endif;
                    }
                ],
                'url:html',
