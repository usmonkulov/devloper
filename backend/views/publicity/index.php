...
/* @var $searchModel backend\models\search\PublicitySearch */
          ...
          'columns' => [
           [
            ...
            // 'image',
              [
                'attribute'=>'image',
                'headerOptions' => ['width' => '100','class' => 'info text-center'],
                'filterOptions' => ['width' => '100','class' => 'success text-center'],
                'contentOptions' =>['width' => '100','class' => 'text-center'],
                'options' => ['class' => 'table-bordered'],
                // 'label' => Yii::t('app','Image'),
                'format' => 'raw',
                'value' => function($data){
                  if($data->image):
                    return ($data->image != NULL && $data->image != '' && !empty($data->image)) ? Html::a(Html::img(Yii::$app->urlManager->createUrl('../../frontend/web/'.$data->image),['style'=>'width:100px'], ['alt'=>$data->image]),['../../frontend/web/'.$data->image]) : '';
                  else:
                    return (Html::img('@web/placeHolder/ad-1.jpg',['style'=>'width:100px']));
                  endif;
                }
              ],
            [
