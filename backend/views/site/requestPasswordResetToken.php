...
<div class="site-login">
    <?php $form = ActiveForm::begin(['id' => 'reset-email-form','options' => ['class' => 'form-login']])?>
        ...
        <?= Html::submitButton('<i class="fa fa-envelope"></i> '.Yii::t('yii', 'Save'), ['class' => 'btn btn-theme btn-block']) ?>
        <hr>
        <div class="login-social-link centered">
            <p><?= Yii::t('yii', 'If you forgot your email you can') ?></p>
        </div>
        <div class="registration">
            <a href="<?=Url::to(['site/login'])?>"><?=Yii::t('yii', 'Login')?></a>
          </div>
        </div>
    <?php ActiveForm::end(); ?>
</div>
