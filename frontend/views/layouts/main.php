            ...
            <div id="nav-fixed">
                <div class="container">
                    ...
                    <ul class="nav-menu nav navbar-nav"> 
                        <li><a href="<?=\yii\helpers\Url::to(['/site/news'])?>"><?=Yii::t('yii','News')?></a></li>
                        <li><a href="<?=\yii\helpers\Url::to(['/site/featured-posts'])?>"><?=Yii::t('yii','Featured Posts')?></a></li>
                            ...
                            <ul class="nav pull-left top-menu">
                                ...
                                <span class="fa fa-user"></span>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="<?= \yii\helpers\Url::to(['site/profile'])?>"><b> <?=Yii::t('yii','My profile')?></b></a></li>
...
\yii\bootstrap\Modal::begin([
    'header' => '<h2>'.Yii::t('yii','Comment').'</h2>',
    'id' => 'comment',
    'size' => 'modal-lg', 
]);
