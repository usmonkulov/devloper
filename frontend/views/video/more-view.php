...
$this->params['breadcrumbs'][] = ['label' => Yii::t('yii','All Videos'), 'url' => ['video/more']];
                  ...
                  <div class="col-md-12">
                      <div class="post">
                         ...
                         <!--  </p> -->
                          <div class="post-body">
                              <div class="post-meta">
                                  <span class="post-date"><?= mb_substr($videos1->updated_at,0,10)?></span>
                              </div>
                              <h3 class="post-title"><?=$videos1->getTitle()?></h3>
                          </div>
                      </div>
                  </div>
                  <!-- /post -->
