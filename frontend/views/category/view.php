			...
			<div class="row">
					...
					<div class="row">
		                ...
		                <div class="col-md-12">
							<div class="section-row">
                                <a href="<?=\yii\helpers\Url::to(['category/more-view', 'id'=>$category->id])?>">
				...
				<div class="col-md-4">
					...
					<div class="aside-widget">
						...
						<?php foreach ($postsview4 as $post):?>
                        <div class="post post-widget">
                            <a class="post-img" href="<?=\yii\helpers\Url::to(['post/view', 'id'=>$post->id])?>">
                                <?php if($post->image_most_read):?>
                                    <?= Html::img("@web/{$post->image_most_read}", ['alt' =>$post->title])?>
                                <?php else:?>
                                    <?= Html::img("@web/placeHolder/placeHolder_view.png", ['alt' =>$post->title])?>
                                <?php endif?>  
                            </a>
                            <div class="post-body">
                                <h3 class="post-title"><a href="<?=\yii\helpers\Url::to(['post/view', 'id'=>$post->id])?>"><?=$posts->getTitle()?></a></h3>
                            </div>
                        </div>
                        <?php endforeach?>
                        <?php endif; ?>
