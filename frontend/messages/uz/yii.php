...
return [
    ...
    'Home' => 'Asosiy',
    'Recent Posts' => 'So‘nggi Xabarlar',
    'Most Read' => 'Ko‘p o‘qilgan' ,
    'Featured Posts' => 'Taniqli xabarlar',
    'Catagories'=>'Bo‘limlar',
    'News' => 'Yangiliklar',
    'Popular' => 'Ommabop',
    'Books' => 'Kitoblar',
    'Load More' => 'Ko‘proq ko‘rish',
    'More' => 'Ko‘proq',
    'Category not found' => 'Bunday bo‘lim mavjud emas',
    'Posts not found' => 'Bunday xabarlar mavjud emas',
    'Enter Your Search' => 'Qidiruvingizni kiriting',
    'Contact' => 'Aloqa',
    'Registration' => 'Roʻyxatdan oʻtish',
    'You need to register to leave comments and use other features of the site' => 'Saytning izoh qoldirish va boshqa imkoniyatlaridan foydalanish uchun roʻyxatdan oʻtish zarur',
    'Already registered' => 'Roʻyxatdan oʻtganmisiz',
    'Login' => 'Kirish',
    'Gender' => 'Jinsi',
    'Male' => 'Erkak',
    'Female' => 'Ayol',
    'Select a region' => 'Viloyatni tanlang',
    'Select District or City' => 'Tuman yoki Shaharni tanlang',
    'Address' => 'Manzil',
    ...
    'Send Email' => 'Elektron pochtaga yuborish',
    'Reset Password' => 'Parolni tiklash',
    'New password' => 'Yangi Parol',
    'Activation email sent to email' => 'Aktivatsiya elektron pochtaga yuborildi',
    'check spam folder' => 'spam papkasini tekshiring',
    'Error. Email not sent.' => 'Xato. Elektron pochtaga xabar yuborilmadi.',
    'Error sending email.' => 'E-pochta xabarini yuborishda xato.',
    'An error occurred while registering.' => 'Ro‘yxatdan o‘tishda xatolik yuz berdi.',
    'Registration error.' => 'Ro‘yxatdan o‘tish xatosi',
    'Activation was successful.' => 'Faollashtirish muvaffaqiyatli amalga oshirildi.',
    ' you are now with ' => ' hozir siz bilan ',
    'Activation error.' => 'Faollashtirishda xatolik.',
    'Error during activation.' => 'Faollashtirish paytida xato.',
    'Check your email.' => 'E-pochtangizni tekshiring.',
    'Password cannot be reset.' => 'Parolni qayta tiklab bo‘lmaydi.',
    'Password changed.' => 'Parol o‘zgartirildi.',
    'This email is not registered.' => 'Ushbu elektron pochta ro‘yxatdan o‘tmagan.',
    'sent by robot' => 'robot tomonidan yuborilgan',
    'Password reset for' => 'Parolni qayta tiklash',
    'The key cannot be empty.' => 'Kalit bo‘sh bo‘lishi mumkin emas.',
    'Wrong key.' => 'Noto‘g‘ri kalit.',
    'Wrong ' => 'Noto‘g‘ri ',
    ' or password.' => ' yoki parol',
    'This name is already taken.' => 'Bu nom allaqachon olingan.',
    'This mail is already taken.' => 'Bu pochta allaqachon olingan.',
    'This phone is already taken.' => 'Bu telefon allaqachon olingan.',
    'This profil is already taken.' => 'Bu profil allaqachon olingan.',
    'Region' => 'Viloyat',
    'District or City' => 'Tuman yoki shahar',
    'All news' => 'Barcha yangiliklar',
    'My profile' => 'Mening profilim',
    'Logout' => 'Chiqish',
    'About Us' => 'Biz haqimizda',
    'Join our Newsletter' => 'Bizning yangiliklarimizga qo‘shiling',
    'Send A Message' => 'Xabar yuboring',
    'Submit' => 'Yuborish',
    'Subject' => 'Mavzu',
    'Message' => 'Xabar',
    'Verification Code' => 'Xavfsizlik Kodi',
    'Follow us' => 'Bizni kuzatib boring',
    'All Featured Posts' => 'Barcha taniqli xabarlar',
    'All' => 'Barcha',
    'Change password' => 'Parolni o‘zgartirish',
    'New password' => 'Yangi parol',
    'Repeat the new password' => 'Qayta tering yangi parolni',
    'Your ID number' => 'Sizning ID raqamingiz',
    'Image' => 'Rasm',
    'Save' => 'Saqlash',
    'The image has been successfully modified' => 'Rasm muvaffaqiyatli o‘zgartirildi',
    'An error occurred while editing the image' => 'Rasm o‘zgartirishda hatolik yuz berdi',
    ...
    'An error occurred while changing the password' => 'Parol o‘zgartirishda xatolik yuz berdi',
    'Name' => 'Nomi',
    'Website' => 'Veb-sayt',
    'Leave a reply' => 'Javob qoldiring',
    'your email address will not be published. required fields are marked' => 'sizning elektron manzilingiz e’lon qilinmaydi. majburiy maydonlar belgilangan',
    'Video' => 'Video',
    'Watched a lot' => 'Ko‘p ko‘rilgan',
    'All videos' => 'Barcha videolar',
    'No such video available' => 'Bunday video mavjud emas',
    'Post not found' => 'Bunday xabar mavjud emas',
    'New Books' => 'Yangi kitoblar',
    'Other categories' => 'Boshqa bo‘limlar',
    'Authors' => 'Mualliflar',
    'Other authors' => 'Boshqa mualliflari',
    'Author not found' => 'Muallif mavjud emas',
    'Quick View' => 'Quick View',
    'Add to Wishlist' => 'Add to Wishlist',
    'Add to Cart' => 'Add to Cart',
    'Date of creation'=>'Yaratilgan sana',  
    'First name' => 'Familiyasi',
    'Second name' => 'Ismi',
